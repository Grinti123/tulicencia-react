...
const RegistrationForm = ({ onSubmit }) => {
  ...
  const handleTownChange = (e, setFieldValue) => {
    ...
    // Also store the town name for API
  ...
  const renderStep1 = ({ errors, touched, values }) => (
    <FadeIn>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <Field
              ...
              disabled={loading}
              error={touched.pueblo && errors.pueblo}
            />
          </div>
  ...
  const renderStep4 = ({ errors, touched, values, isSubmitting }) => (
    <FadeIn>
      <div className="space-y-4">
