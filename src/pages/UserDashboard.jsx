        ...
        <div className="py-8 flex gap-8">
          ...
          <div className="w-90 flex-shrink-0 p-6 rounded-xl shadow-lg bg-gradient-to-br from-[#e8f8ee] via-white to-[#e8f8ee] border border-[#e8f8ee]">
            ...
            <Link to="/dashboard/procedures" className="block">
              <Button variant="primary" fullWidth className="py-3 flex items-center justify-start px-4 cursor-pointer">
            ...
            <Link to="/dashboard/profile" className="block">
              <Button variant="secondary" fullWidth className="py-3 flex items-center justify-start px-4 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
