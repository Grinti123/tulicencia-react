      ...
      <main className="flex-grow py-8">
        <Container size="lg">
          <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm">
            <h1 className="text-3xl font-bold text-[#157a3c] mb-6">Privacy Policy</h1>
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-xl font-semibold text-[#157a3c] mt-6 mb-3">2. The Data We Collect</h2>
              ...
              <h2 className="text-xl font-semibold text-[#157a3c] mt-6 mb-3">3. How We Use Your Data</h2>
              ...
              <h2 className="text-xl font-semibold text-[#157a3c] mt-6 mb-3">4. Data Security</h2>
              <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.</p>
              
              <h2 className="text-xl font-semibold text-[#157a3c] mt-6 mb-3">5. Contact Us</h2>
