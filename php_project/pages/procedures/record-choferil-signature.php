...
$title = "Record Choferil - Digital Signature";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $redirect = true;
    $redirectUrl = 'index.php?page=record-choferil-success';
}
...
<head>
    ...
    <title>Record Choferil - Digital Signature - Tu Licencia</title>
            ...
            <div class="bg-[#e8f8ee] rounded-3xl p-6 md:p-10 shadow-sm">
                <form method="POST" action="" id="signatureForm" class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-lg text-center mt-2">Que nos servirá para validar tus documentos</p>
                    </div>
    ...
    <div class="bg-white rounded-lg max-w-2xl w-full mx-4 p-6">
        ...
        <div class="border border-gray-200 rounded-lg p-6 bg-white">
            <div class="flex justify-center mb-4">
                <h3 class="text-xl font-bold">Carta de Autorización</h3>
            </div>
            <p class="mb-6">
                Sirva la presente carta para autorizar a Autodocs LLC Dba Cesco Online y 
                sus gestores autorizados a tramitar cualquier gestión necesaria ante el 
                Departamento de Transportación y Obras Públicas, CESCO, DISCO, 
                Autoexpreso y agencia necesaria para el procesamiento de mi licencia de 
                conducir y/o gestiones vehiculares.
            </p>
            <p class="mb-4">
                Gracias,
            </p>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('signatureForm').addEventListener('submit', function(event) {
            ...
            // We could also redirect using JavaScript here instead of relying on PHP
            // Uncomment this if you want to redirect directly from JavaScript
            /*
            event.preventDefault();
            setTimeout(function() {
                window.location.href = 'index.php?page=record-choferil-success';
            }, 500);
            */
        });
    });
