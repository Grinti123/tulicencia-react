...
$title = "Duplicado de Título - Subir Documentos";
...
<head>
    ...
    <title>Duplicado de Título - Subir Documentos - Tu Licencia</title>
        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="bg-[#e8f8ee] rounded-3xl p-6 md:p-10 shadow-sm">
                ...
                <p class="text-gray-700 mb-8 text-center">
                    Por favor, sube los siguientes documentos para completar tu solicitud de duplicado de título.
                </p>
                
                <form action="index.php?page=duplicado-titulo-success" method="GET" class="space-y-6">
                    <input type="hidden" name="page" value="duplicado-titulo-success">
                    
                    <!-- Document Upload Section -->
                    <div class="space-y-4 max-w-lg mx-auto">
                        <!-- Declaración jurada -->
                        <div class="bg-[#f0f9f4] p-5 rounded-lg">
                            <h3 class="text-[#157a3c] font-medium mb-4">Declaración jurada <span class="text-red-500">*</span></h3>
                        ...
                        <div class="bg-[#f0f9f4] p-5 rounded-lg">
                            <h3 class="text-[#157a3c] font-medium mb-4">Licencia del vehículo <span class="text-red-500">*</span></h3>
                        ...
                        <!-- Licencia de conducir (propietario) -->
                        <div class="bg-[#f0f9f4] p-5 rounded-lg">
                            <h3 class="text-[#157a3c] font-medium mb-4">Licencia de conducir (propietario) <span class="text-red-500">*</span></h3>
                    ...
                    <div class="flex flex-col-reverse md:flex-row md:justify-between mt-10 gap-4">
                        <a href="index.php?page=duplicado-titulo-signature" 
