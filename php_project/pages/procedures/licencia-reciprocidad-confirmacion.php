...
$title = "Licencia de Reciprocidad - Confirmación";
...
<head>
    ...
    <title>Licencia de Reciprocidad - Confirmación - Tu Licencia</title>
...
<div class="min-h-screen flex flex-col items-center justify-center bg-[#e8f8ee]">
    <div class="max-w-4xl w-full mx-auto px-4 py-12 text-center">
        ...
        <div class="flex flex-col items-center gap-4 mt-6">
            <a href="index.php?page=licencia-reciprocidad-upload" 
