...
$title = "Licencia de Reciprocidad - Solicitud Completada";
...
<head>
    ...
    <title>Licencia de Reciprocidad - Solicitud Completada - Tu Licencia</title>
...
<div class="min-h-screen flex flex-col bg-[#f7fdf9]">
    <div class="max-w-4xl w-full mx-auto px-4 py-12 text-center">
        ...
        <h2 class="text-4xl font-bold text-[#157a3c] mb-4">¡Felicidades <?php echo htmlspecialchars($userName); ?>!</h2>
        
        <p class="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
            Tu trámite de Licencia de Reciprocidad ha concluido exitosamente.
        </p>
        ...
        <div class="bg-white rounded-xl p-6 mb-8 max-w-lg mx-auto shadow-sm">
            ...
            <p class="text-gray-700">
                Te notificaremos por correo electrónico cuando tu licencia esté lista para recoger.
            </p>
        </div>
