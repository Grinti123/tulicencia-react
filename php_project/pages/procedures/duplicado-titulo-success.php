...
$title = "Duplicado de Título - Completado";
...
<head>
    ...
    <title>Duplicado de Título - Completado - Tu Licencia</title>
        ...
        <div class="max-w-4xl w-full mx-auto px-4">
            <div class="bg-[#e8f8ee] rounded-3xl p-6 md:p-10 text-center shadow-sm">
                ...
                <p class="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
                    Tu solicitud de duplicado de título ha sido recibida. Nos pondremos en contacto contigo 
                    para informarte cuando tu nuevo título esté listo.
                </p>
